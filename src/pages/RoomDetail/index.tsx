...
export default function BookingDetailPage() {
  ...
  const roomDetailsMap: Record<number, RoomDetails> = {
    1: {
      ...
      images: ["/double-room-hotel.jpg", "/double-room-hotel.jpg", "/double-room-hotel.jpg"],
    ...
    3: {
      ...
      images: ["/luxury-spa-relaxation.jpg", "/luxury-spa-relaxation.jpg", "/luxury-spa-relaxation.jpg"],
    ...
    5: {
      ...
      images: ["/standard-hotel-room.jpg", "/standard-hotel-room.jpg", "/standard-hotel-room.jpg"],
